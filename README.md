<h1 align="center">Max Bot Solaris</h1>

<p align="center">
  Max-бот для клуба Solaris, который помогает пользователю выбрать формат отдыха,
  собрать понятную заявку и передать ее менеджеру через Bitrix24.
</p>

<p align="center">
  <strong>Python 3.13</strong> | <strong>aiomax</strong> | <strong>PostgreSQL</strong> | <strong>Alembic</strong> | <strong>Bitrix24</strong>
</p>

## О проекте

Этот проект превращает общение в Max в короткую и понятную воронку:
...
- `src/app/Max` - роутеры, состояния FSM, клавиатуры и пользовательские сценарии.
